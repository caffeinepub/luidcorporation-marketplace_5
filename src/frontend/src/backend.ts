...
export class Backend implements backendInterface {
    ...
    async addScriptForSale(arg0: string, arg1: string, arg2: Category, arg3: number, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addScriptForSale(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllScripts(): Promise<Array<Record_>> {
        if (this.processError) {
            try {
    ...
    async getAllUserAccounts(): Promise<Array<Account>> {
        if (this.processError) {
            try {
    ...
    async getPurchasedScripts(arg0: LuidId): Promise<Array<ScriptId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPurchasedScripts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getScriptById(arg0: ScriptId): Promise<Record_> {
        if (this.processError) {
            try {
    ...
    async getScriptsByCategory(arg0: Category): Promise<Array<Record_>> {
        if (this.processError) {
            try {
    ...
    async getScriptsByLanguage(arg0: string): Promise<Array<Record_>> {
        if (this.processError) {
            try {
                const result = await this.actor.getScriptsByLanguage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasPurchasedScript(arg0: LuidId, arg1: ScriptId): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPurchasedScript(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isRegistered(arg0: LuidId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async login(arg0: LuidId, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async purchaseScript(arg0: LuidId, arg1: ScriptId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.purchaseScript(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async register(arg0: LuidId, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateScript(arg0: ScriptId, arg1: string, arg2: string, arg3: Category, arg4: number, arg5: string, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateScript(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
